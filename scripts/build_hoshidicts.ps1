...
$hoshidictsRoot = Join-Path $repoRoot 'external\hoshidicts'
$buildRoot = Join-Path $repoRoot 'build\hoshidicts'
$outputRoot = Join-Path $repoRoot 'native\bin'
...
$source = Join-Path $buildRoot 'Release\sel-pop-hoshidicts-server.exe'
